\chapter{Unmanned Aerial Vehicles}
...
\begin{figure}
  ...
  \caption{Types of \glentryshortspl{uav} based on their design and intended use \autocite{mohnani2022role}. a. Rotary-wing \glsentryshort{uav}, b. Fixed-wing \glsentryshort{uav}, c. Hybrid \glsentryshort{uav}}
  \label{fig:uav_types}
\end{figure}
...
\begin{table}
  \begin{tabular}{ l c c c }
    ...
    \bottomrule
  \end{tabular}
  \caption{Comparison of fixed-wing, rotary-wing, and hybrid \glsentryshortpl{uav} across various performance metrics}
